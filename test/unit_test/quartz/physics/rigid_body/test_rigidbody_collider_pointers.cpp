...
// 
//     reactphysics3d::Collider* p_collider = quartz::physics::Collider::createColliderPtr(p_rigidBody, false, p_boxShape, {});
...
//     const quartz::physics::Collider collider = quartz::physics::Collider::createBoxCollider(physicsManager, p_rigidBody, false, {}, boxShapeParameters);
// 
...
// 
//     const quartz::physics::BoxShape::Parameters boxShapeParameters({1.0f, 1.0f, 1.0f});
//     const std::optional<quartz::physics::Collider> o_collider = quartz::physics::Collider::createBoxCollider(physicsManager, p_rigidBody, false, {}, boxShapeParameters);
...
// 
//     const quartz::physics::BoxShape::Parameters boxShapeParameters({1.0f, 1.0f, 1.0f});
//     const quartz::physics::RigidBody rigidBody(physicsManager, p_rigidBody, false, {}, boxShapeParameters);
//     
