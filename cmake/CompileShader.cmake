...
function(compile_shaders TARGET_NAME OUTPUT_DIR INPUT_DIR)
    ...
    foreach(SHADER_SOURCE_FILE IN LISTS SHADER_SOURCE_FILE_LIST)
        ...
        message(STATUS "    Processing shader ${SHADER_SOURCE_FULL_FILE}")
        message(STATUS "      Using tempfile ${SHADER_SOURCE_FULL_TEMPFILE}")
        ...
        add_custom_command(
            ...
            COMMAND
                sed "s/#define MAX_NUMBER_TEXTURES -1/#define MAX_NUMBER_TEXTURES 100/g" ${SHADER_SOURCE_FULL_FILE} > ${SHADER_SOURCE_FULL_TEMPFILE} &&
